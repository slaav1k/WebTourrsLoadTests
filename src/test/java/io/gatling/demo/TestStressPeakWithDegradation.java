...
public class TestStressPeakWithDegradation extends Simulation {
...

    {
        setUp(
                UC1_BuyTicket.injectClosed(
                        rampConcurrentUsers(0).to(62).during(Duration.ofMinutes(3)),
                        constantConcurrentUsers(62).during(Duration.ofMinutes(7)),
                        rampConcurrentUsers(62).to(44).during(Duration.ofSeconds(10)),
                        constantConcurrentUsers(44).during(Duration.ofMinutes(2)),
                        rampConcurrentUsers(44).to(32).during(Duration.ofSeconds(10)),
                        constantConcurrentUsers(32).during(Duration.ofMinutes(2)),
                        rampConcurrentUsers(32).to(25).during(Duration.ofSeconds(10)),
                        constantConcurrentUsers(25).during(Duration.ofMinutes(2)),
                        rampConcurrentUsers(25).to(19).during(Duration.ofSeconds(10)),
                        constantConcurrentUsers(19).during(Duration.ofMinutes(2)),
                        rampConcurrentUsers(19).to(0).during(Duration.ofSeconds(10))
                ),
                UC2_DeleteFirstItinerary.injectClosed(
                        rampConcurrentUsers(0).to(31).during(Duration.ofMinutes(3)),
                        constantConcurrentUsers(31).during(Duration.ofMinutes(7)),
                        rampConcurrentUsers(31).to(22).during(Duration.ofSeconds(10)),
                        constantConcurrentUsers(22).during(Duration.ofMinutes(2)),
                        rampConcurrentUsers(22).to(16).during(Duration.ofSeconds(10)),
                        constantConcurrentUsers(16).during(Duration.ofMinutes(2)),
                        rampConcurrentUsers(16).to(12).during(Duration.ofSeconds(10)),
                        constantConcurrentUsers(12).during(Duration.ofMinutes(2)),
                        rampConcurrentUsers(12).to(9).during(Duration.ofSeconds(10)),
                        constantConcurrentUsers(9).during(Duration.ofMinutes(2)),
                        rampConcurrentUsers(9).to(0).during(Duration.ofSeconds(10))
                ),
                ...
                .maxDuration(Duration.ofMinutes(21));
    }
}