...
public class TestFindMax20min extends Simulation {
...

    {
        setUp(
                UC1_BuyTicket.injectClosed(
                        ...
                        constantConcurrentUsers(16).during(Duration.ofMinutes(22)),
                        rampConcurrentUsers(16).to(18).during(Duration.ofMinutes(1)),
                        constantConcurrentUsers(18).during(Duration.ofMinutes(22)),
                        rampConcurrentUsers(18).to(20).during(Duration.ofMinutes(1)),
                        constantConcurrentUsers(20).during(Duration.ofMinutes(22)),
                        rampConcurrentUsers(20).to(0).during(Duration.ofMinutes(2))
                ),
                UC2_DeleteFirstItinerary.injectClosed(
                        ...
                        constantConcurrentUsers(8).during(Duration.ofMinutes(22)),
                        rampConcurrentUsers(8).to(9).during(Duration.ofMinutes(1)),
                        constantConcurrentUsers(9).during(Duration.ofMinutes(22)),
                        rampConcurrentUsers(9).to(10).during(Duration.ofMinutes(1)),
                        constantConcurrentUsers(10).during(Duration.ofMinutes(22)),
                        rampConcurrentUsers(10).to(0).during(Duration.ofMinutes(2))
                ),
                ...
                .maxDuration(Duration.ofMinutes(83));
    }
}