...
public class TestFindMax5min extends Simulation {
...

    {
        setUp(
                UC1_BuyTicket.injectClosed(
                        ...
                        constantConcurrentUsers(16).during(Duration.ofMinutes(5)),
                        rampConcurrentUsers(16).to(18).during(Duration.ofMinutes(1)),
                        constantConcurrentUsers(18).during(Duration.ofMinutes(5)),
                ...
                UC2_DeleteFirstItinerary.injectClosed(
                        ...
                        constantConcurrentUsers(8).during(Duration.ofMinutes(5)),
                        rampConcurrentUsers(8).to(9).during(Duration.ofMinutes(1)),
                        constantConcurrentUsers(9).during(Duration.ofMinutes(5)),
